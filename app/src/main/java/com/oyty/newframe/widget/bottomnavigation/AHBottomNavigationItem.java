...
public class AHBottomNavigationItem {
    ...
    private String imgUnSelectedUrl;
    ...
    public AHBottomNavigationItem(String title, String imgSelectedUrl, String imgUnSelectedUrl) {
        this.title = title;
        this.imgSelectedUrl = imgSelectedUrl;
        this.imgUnSelectedUrl = imgUnSelectedUrl;
    }
    ...
    public String getImgUnSelectedUrl() {
        return imgUnSelectedUrl;
    }
