package com.oyty.newframe.widget.bottomnavigation;
...
import com.oyty.newframe.widget.bottomnavigation.notification.AHNotification;
import com.oyty.newframe.widget.bottomnavigation.notification.AHNotificationHelper;
import com.oyty.newframe.widget.image.glide.GlideApp;
...
//						current ? itemActiveColor : itemInactiveColor, forceTint));
				loadIcon(current ? item.getImgSelectedUrl() : item.getImgUnSelectedUrl(), icon);
...
//						itemDisableColor, forceTint));
                loadIcon(item.getImgUnSelectedUrl(), icon);
...
//						currentItem == i ? itemActiveColor : itemInactiveColor, forceTint));
                loadIcon(currentItem == i ? item.getImgSelectedUrl() : item.getImgUnSelectedUrl(), icon);
...
//						itemInactiveColor, itemActiveColor, forceTint);
                loadIcon(items.get(i).getImgSelectedUrl(), icon);
...
//						itemActiveColor, itemInactiveColor, forceTint);
                loadIcon(items.get(currentItem).getImgUnSelectedUrl(), icon);
			}
		}
...
//						itemActiveColor, itemInactiveColor, forceTint);
    ...
    private void loadIcon(String url, ImageView icon) {
        GlideApp.with(context)
                .load(QiniuUtil.getImageURL(url))
